...
export default function VisionSection({
  ...
  const imageUrl = data?.vision_image_url || "";
  const heading = data?.vision_heading || "";
  const paragraph = data?.vision_paragraph || "";
  ...
  return (
    <section className={`w-full py-12 sm:py-16 md:pt-12 md:pb-12 bg-white text-neutral-900 select-none ${className}`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 w-full space-y-4 sm:space-y-5">
